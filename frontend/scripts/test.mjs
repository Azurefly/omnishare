...
const [html,js,manifest,sw,packageText]=await Promise.all(['web/index.html','web/app.js','web/manifest.webmanifest','web/service-worker.js','package.json'].map(p=>readFile(resolve(root,p),'utf8')))
